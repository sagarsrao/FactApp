...
import com.wipro.factapp.FactAppStarterApplication
import com.wipro.factapp.injection.component.ActivityComponent
import com.wipro.factapp.injection.component.ConfigPersistentComponent
import com.wipro.factapp.injection.component.DaggerConfigPersistentComponent
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (componentsArray.get(activityId) == null) {
            ...
            configPersistentComponent = DaggerConfigPersistentComponent.builder()
                    .appComponent(FactAppStarterApplication[this].component)
                    .build()
